...
printf -v str_RANGE "%.${DECIMALPLACES}f" $RANGE
printf -v str_RANGE_TOTAL_MINUTES "%.${DECIMALPLACES}f" $RANGE_TOTAL_MINUTES
printf -v str_RANGE_TOTAL_HOURS "%.${DECIMALPLACES}f" $RANGE_TOTAL_HOURS
printf -v str_RANGE_TOTAL_DAYS "%.${DECIMALPLACES}f" $RANGE_TOTAL_DAYS
printf -v str_RANGE_TOTAL_WEEKS "%.${DECIMALPLACES}f" $RANGE_TOTAL_WEEKS
printf -v str_RANGE_TOTAL_MONTHS "%.${DECIMALPLACES}f" $RANGE_TOTAL_MONTHS
printf -v str_RANGE_TOTAL_YEARS "%.${DECIMALPLACES}f" $RANGE_TOTAL_YEARS


printf -v str_ONEPERCENT_RANGE "%.${DECIMALPLACES}f" $ONEPERCENT_RANGE
printf -v str_ONEPERCENT_RANGE_TOTAL_MINUTES "%.${DECIMALPLACES}f" $ONEPERCENT_RANGE_TOTAL_MINUTES
printf -v str_ONEPERCENT_RANGE_TOTAL_HOURS "%.${DECIMALPLACES}f" $ONEPERCENT_RANGE_TOTAL_HOURS
printf -v str_ONEPERCENT_RANGE_TOTAL_DAYS "%.${DECIMALPLACES}f" $ONEPERCENT_RANGE_TOTAL_DAYS
printf -v str_ONEPERCENT_RANGE_TOTAL_WEEKS "%.${DECIMALPLACES}f" $ONEPERCENT_RANGE_TOTAL_WEEKS
printf -v str_ONEPERCENT_RANGE_TOTAL_MONTHS "%.${DECIMALPLACES}f" $ONEPERCENT_RANGE_TOTAL_MONTHS
printf -v str_ONEPERCENT_RANGE_TOTAL_YEARS "%.${DECIMALPLACES}f" $ONEPERCENT_RANGE_TOTAL_YEARS
...
printf -v str_SECONDS_LEFT "%.${DECIMALPLACES}f" $SECONDS_LEFT
printf -v str_SECONDS_PASSED "%.${DECIMALPLACES}f" $SECONDS_PASSED

printf -v str_PASSED_PERCENT "%.${DECIMALPLACES}f" $PASSED_PERCENT
printf -v str_LEFT_PERCENT "%.${DECIMALPLACES}f" $LEFT_PERCENT


printf -v str_PASSED_TOTAL_MINUTES "%.${DECIMALPLACES}f" $PASSED_TOTAL_MINUTES
printf -v str_PASSED_TOTAL_HOURS "%.${DECIMALPLACES}f" $PASSED_TOTAL_HOURS
printf -v str_PASSED_TOTAL_DAYS "%.${DECIMALPLACES}f" $PASSED_TOTAL_DAYS
printf -v str_PASSED_TOTAL_WEEKS "%.${DECIMALPLACES}f" $PASSED_TOTAL_WEEKS
printf -v str_PASSED_TOTAL_MONTHS "%.${DECIMALPLACES}f" $PASSED_TOTAL_MONTHS
printf -v str_PASSED_TOTAL_YEARS "%.${DECIMALPLACES}f" $PASSED_TOTAL_YEARS


printf -v str_REMAINING_TOTAL_MINUTES "%.${DECIMALPLACES}f" $REMAINING_TOTAL_MINUTES
printf -v str_REMAINING_TOTAL_HOURS "%.${DECIMALPLACES}f" $REMAINING_TOTAL_HOURS
printf -v str_REMAINING_TOTAL_DAYS "%.${DECIMALPLACES}f" $REMAINING_TOTAL_DAYS
printf -v str_REMAINING_TOTAL_WEEKS "%.${DECIMALPLACES}f" $REMAINING_TOTAL_WEEKS
printf -v str_REMAINING_TOTAL_MONTHS "%.${DECIMALPLACES}f" $REMAINING_TOTAL_MONTHS
printf -v str_REMAINING_TOTAL_YEARS "%.${DECIMALPLACES}f" $REMAINING_TOTAL_YEARS
